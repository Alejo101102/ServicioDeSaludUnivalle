...
/**
 * Fundamentos de programación orientada a eventos 750014C-01 Laboratorio #
 * Profesor: Luis Romo Portilla
 *
 * Archivo: VentanaAfiliadosControlador.java Licencia: GNU-GPL
 *
 * @version 1.0
 *
 * @author Alejandro Guerrero Cano (202179652-3743)
 * {@literal <"alejandro.cano@correounivalle.edu.co">}
 * @author Estiven Andres Martinez Granados (202179687-3743)
 * {@literal <"estiven.martinez@correounivalle.edu.co">}
